            ...
            caption.post(new Runnable() {
                ...
                public void run() {
                   ...
                   // caption.setEnabled(false);
                    caption.setText("");
                    caption.setTextSize(TypedValue.COMPLEX_UNIT_PX, AuthFragment.this.getResources().getDimension(R.dimen.unfolded_size));
                    caption.setTextColor(ContextCompat.getColor(AuthFragment.this.getContext(), R.color.color_label));
                    caption.setTranslationX(0);
                    ConstraintLayout.LayoutParams params = AuthFragment.this.getParams();

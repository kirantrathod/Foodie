...
public class Reply_reviews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reply_reviews);
    ...
    private void loadMessages() {
        DatabaseReference messageRef=mRootref.child("feedbacks").child(mCurrentuserid);
...
//updated at 16/08/2017========orderbychild was required for ordering data(pushed data)=======================
    ...
    private void sendMessage() {
     ...
     //       String current_user_ref="feedbacks/" + mCurrentuserid;
            //String chat_user_ref="feedbacks/" + mchatuser;

            DatabaseReference user_message_push=mRootref.child("feedbacks").child(mCurrentuserid)
                    .push();
...
//=============================================================================================================================
            ...
            //user_message_push.setValue(messagemap);

            mchat_messageview.setText(" ");

      /*      DatabaseReference newNotificationref=mRootref.child("feedback_notification").child(mCurrentuserid).push();
